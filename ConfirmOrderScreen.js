...
const OrderScreen = () => {
  ...
  const renderStepContent = () => {
    ...
    <View style={styles.gcashLogoContainer}>
      <Image 
        source={require('../assets/gcashlogo.png')}  style={styles.gcashLogo} resizeMode="contain"/>
    </View>
...
<TouchableOpacity onPress={() => setDeliveryMethod('Points')} style={styles.deliveryOption}>
    ...
    <View style={styles.gcashLogoContainer}>
      <Image 
        source={require('../assets/points.webp')}  style={styles.gcashLogo} resizeMode="contain"/>
    </View>
